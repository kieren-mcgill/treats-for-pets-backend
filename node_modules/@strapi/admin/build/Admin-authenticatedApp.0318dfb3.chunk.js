"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[801],{29761:function(Q,S,n){n.r(S),n.d(S,{default:function(){return $t}});var e=n(32735),s=n(24989),L=n(20108),v=n(33795),O=n.n(v),P={i8:"4.10.6"},C=n(67927),f=n(53038),y=n(15062),G=n(74506),z=n(51968),K=n(88311),ne=n.n(K),Le=n(58107),T=n(8471),Oe=n(60216),r=n.n(Oe),Z=n(67879),m=n(87933),ae=n(71933),oe=n(67563),xe=n(50563),M=n(72850),V=n(41415),se=n(35331);const be=(0,T.ZP)(m.k)`
  position: fixed;
  z-index: 4;
  inset: 0;
